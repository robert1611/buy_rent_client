        ...
        <div className="privacy-policy-content text-left">
          ...
          <p><strong>Most Important Factors To Weigh</strong> </p>
            <ul>
              ...
              <li><strong>Down payment</strong></li><p>You don't always need 20%. The VA will requires little money down, and FHA only 3.5%. But below 20% requires extra monthly fees pcalled PMI</p>
          ...
          <ul>
              <li><strong>Fewer Inputs</strong></li><p>Why enter well known costs that can easily be caculated off your purchase price? <br></br> Based off your purchase price, effective property tax rates are 1.82%, insurance costs 0.8%, ongoing maintence costs 1% , and buy / sell costs 10%</p>
              ...
              <li><strong>Different Approach</strong></li><p>We calculate an interest rate against the entire cost of purchase, not just the loan.  Why? Because the downpayment could used for something else <br></br>We don't include repayment of principal, just the interest.  Lastly, we build in transaction costs</p>
